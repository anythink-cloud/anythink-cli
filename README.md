...
curl -Lo anythink https://github.com/Anythink-Ltd/anythink-cli/releases/latest/download/anythink-osx-arm64
chmod +x anythink
...
cd anythink-cli
cp .env.example .env
# Edit .env with your dev/local environment values if needed
dotnet build
```
