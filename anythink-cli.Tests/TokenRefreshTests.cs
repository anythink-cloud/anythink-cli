...
public class TryRefreshSyncTests : IDisposable
{
    ...
    private static AnythinkCli.Config.Profile ExpiredProfile(string baseUrl = "https://api.example.com", string orgId = "42") =>
        new()
        {
            OrgId          = orgId,
            BaseUrl        = baseUrl,
    ...
    private void SaveProfile(AnythinkCli.Config.Profile profile, string key = "default")
    {
